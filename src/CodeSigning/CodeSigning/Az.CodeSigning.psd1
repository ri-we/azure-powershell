#
# Module manifest for module 'Az.CodeSigning'
#
...
GUID = 'ea901aab-24ca-4004-a198-b9a37a4c8070'
...
NestedModules = @('Microsoft.Azure.PowerShell.Cmdlets.CodeSigning.dll')
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added ''Get-AzCodeSigningCertChain'' cmdlet to retrieve the certificate chain for a certificate profile.'
